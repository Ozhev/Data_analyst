...
Как решил: Импортировал данные в окружение Jupyter Notebook, изучил данные и исключил нулловые значения. Далее объединил и визуализировал данные, автоматизировал статистические вычисления, применяя критерии Стьюдента и Манна Уитни. Провел расчет и сегментацию A/B-тестов.
